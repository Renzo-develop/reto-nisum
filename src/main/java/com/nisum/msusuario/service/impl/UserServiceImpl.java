...
import com.nisum.msusuario.exception.NotAuthorizedException;
...
public class UserServiceImpl implements UserService {
    ...
    public List<User> getUsers() {
        ...
        userRepository.findAll()
                .forEach(user -> users.add(ApiResponse.mutate(user)));
    ...
    public Optional<User> findByEmail(String email) {
        ...
        return userRepository.findByEmail(email).map(user -> ApiResponse.mutate(user));
